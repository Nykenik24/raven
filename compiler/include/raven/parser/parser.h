...
tree_t *parse_stmt_switch(token_list_t *tokens, size_t *index);
tree_t *parse_stmt_defer(token_list_t *tokens, size_t *index);
tree_t *parse_stmt_return(token_list_t *tokens, size_t *index);
tree_t *parse_stmt_throw(token_list_t *tokens, size_t *index);
tree_t *parse_stmt_try(token_list_t *tokens, size_t *index);
tree_t *parse_stmt_loop(token_list_t *tokens, size_t *index);
tree_t *parse_stmt_loop_for(token_list_t *tokens, size_t *index);
tree_t *parse_stmt_loop_while(token_list_t *tokens, size_t *index);
tree_t *parse_stmt_loop_until(token_list_t *tokens, size_t *index);
tree_t *parse_stmt_loop_repeat(token_list_t *tokens, size_t *index);
