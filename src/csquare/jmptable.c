 ...
 * @details Sets up the character classification table that maps input
 * characters to their corresponding lexer functions for efficient tokenization.
 */
...
csq_lexstate get_lex_state(unsigned char c) { return state_table[c]; }
